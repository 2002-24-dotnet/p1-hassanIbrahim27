     ...
     protected override void OnModelCreating(ModelBuilder builder)//convert c# obj to sql
      {
        ...
        {
          new User(){UserName = "user1", Password="123", Type="U"},
          new User(){UserName = "user2", Password="234", Type="U"},
          new User(){UserName = "user3", Password="345", Type="U"},
          new User(){UserName = "user4", Password="456", Type="U"},
          new User(){UserName = "store1", Password="123", Type="S"},
          new User(){UserName = "store2", Password="234", Type="S"}
        });
